  ...
  constructor(gameW, gameH) {
   ...
   drawBody(context) {
    ...
    for(var i = 1; i < this.body.length - 1; i++) {
      this.body[i].draw(context, this.caterImages[10][0]);
    }

    if(this.body[this.body.length-1].direction === 'up') {
      this.body[this.body.length-1].draw(context, this.caterImages[6]);
    } else if(this.body[this.body.length-1].direction === 'down') {
      this.body[this.body.length-1].draw(context, this.caterImages[7]);
    } else if(this.body[this.body.length-1].direction === 'left') {
      this.body[this.body.length-1].draw(context, this.caterImages[8]);
    } else {
      this.body[this.body.length-1].draw(context, this.caterImages[9]);
    }
  } 
